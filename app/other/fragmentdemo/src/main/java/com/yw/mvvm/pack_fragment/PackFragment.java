package com.yw.mvvm.pack_fragment;
...
import com.yw.mvvm.R;

/**
 * A simple {@link Fragment} subclass.
 * Activities that contain this fragment must implement the
 * {@link PackFragment.OnFragmentInteractionListener} interface
...
public class PackFragment extends Fragment implements View.OnClickListener {
    ...
    public void onClick(View v) {
        if (getActivity() instanceof OnClickListenrByFragment) {
            ((OnClickListenrByFragment) getActivity()).onClickByFragment(v);
        }
    }

   public interface OnClickListenrByFragment {
        void onClickByFragment(View view);
    }
