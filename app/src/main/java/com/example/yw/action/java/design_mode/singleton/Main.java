package com.example.yw.action.java.design_mode.singleton;

import android.os.Handler;
import android.os.Message;

import com.example.yw.action.java.design_mode.singleton.The_class_level_holder_class.ClassLevelSingleton;
import com.example.yw.action.java.design_mode.singleton.duplication_check.CheckSingleton;
import com.example.yw.action.java.design_mode.singleton.hungry.HungrySingleton;
import com.example.yw.action.java.design_mode.singleton.lazy.LazySingleton;
