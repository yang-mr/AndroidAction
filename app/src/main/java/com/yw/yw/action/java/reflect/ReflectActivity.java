package com.yw.yw.action.java.reflect;
...
public class ReflectActivity extends AppCompatActivity {
    ...
    static class Bean {
        ...
        List<String> list;
        // Map<String,PersonViewModel> map 这个 ParameterizedType 的 getOwnerType() 为 null，
    ...
    */
    private static void getClassFields() {
        // Class userClass = UserViewModel.class;
        Class userClass = null;
        try {
            userClass = Class.forName("com.yw.yw.action.java.reflect.User");
    ...
    private static void testGetObject() {
        ...
        Class ForName = null;
        try {
            ForName = Class.forName("com.yw.yw.action.java.reflect.User");
        } catch (ClassNotFoundException e) {
            e.printStackTrace();
        }
